  ...
  return (
    <div className="bg-white dark:bg-gray-800 min-h-full shadow-md px-4 py-6 flex flex-col">
      <div className="flex flex-col items-center mb-8">
        ...
        <h2 className="text-lg font-semibold">{currentUser?.name || 'Faculty'}</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">{currentUser?.designation || 'Staff'}</p>
      </div>
